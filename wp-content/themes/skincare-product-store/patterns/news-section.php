 ...
 * News Section
 * 
 * slug: skincare-product-store/news-section
 * title: News Section
 * categories: skincare-product-store
 */

    return array(
        'title'      =>__( 'News Section', 'skincare-product-store' ),
    ...
    <div id="blog" class="wp-block-group news-section wow bounceIn" style="padding-top:0;padding-bottom:0"><!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|accent"}}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"accent","fontSize":"medium","fontFamily":"rubik"} -->
    <p class="has-text-align-center has-accent-color has-text-color has-link-color has-rubik-font-family has-medium-font-size" style="font-style:normal;font-weight:600">'. esc_html__('News & Blogs','skincare-product-store').'</p>
    <!-- /wp:paragraph -->

    <!-- wp:heading {"textAlign":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"800","fontSize":"26px"},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontFamily":"rubik"} -->
    <h2 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-link-color has-rubik-font-family" style="font-size:26px;font-style:normal;font-weight:800">'. esc_html__('Our Latest News & blogs','skincare-product-store').'</h2>
    <!-- /wp:heading -->
