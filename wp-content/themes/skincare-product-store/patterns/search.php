 ...
 * Search Section
 * 
 * slug: skincare-product-store/search-page
 * title: Search Page
 * categories: skincare-product-store
 */

return array(
    'title'      =>__( 'Search Page', 'skincare-product-store' ),
...
<h2 class="wp-block-heading has-text-align-center">'. esc_html__(' No results found','skincare-product-store') .'</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"> '. esc_html__('  We could not find any posts matching your search. Try different keywords.','skincare-product-store') .'</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
